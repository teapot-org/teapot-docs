...
[2.1 Назначение разработки](#2.1-Назначение-разработки)

[2.2.1 Цель разработки](#2.2.1-Цель-разработки)

[2.2.2 Целевая аудитория](#2.2.2-Целевая-аудитория)

[3. Требования к программному изделию](#3-Требования-к-программному-изделию)

[3.1 Требования к структуре](#3.1-Требования-к-структуре)

[3.2 Требования к разграничению доступа](#3.2-Требования-к-разграничению-доступа)

[3.3 Требования к функциональным характеристикам](#3.3-Требования-к-функциональным-характеристикам)

[3.3.1 Структура Web-приложения](#3.3.1-Структура-Web-приложения)

[3.3.2 Основные функции](#3.3.2-Основные-функции)

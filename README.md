...
------------------------- | ----------------------
Администратор|<ul><li>подтверждение регистрации сотрудников компании; назначение прав доступа руководителям рабочих групп/проектов; назначение статусов пользователям.</li></ul>
